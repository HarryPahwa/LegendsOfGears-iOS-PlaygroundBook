...
public class GameViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    override public func viewDidLoad() {
        ...
        skView.addGradientWithColor(UIColor.blue, UIColor.white, CGRect(x:0, y:0, width: totalWidth, height: totalHeight * 2))
        skView.addGradientWithColor(UIColor.blue, UIColor.white, CGRect(x:0, y:0, width: totalWidth, height: totalHeight))
